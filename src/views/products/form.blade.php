                            ...
                            <div class="@if($key==0) active fade in @endif tab-pane panel panel-default" id="{{$locale}}">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description_{{$locale}}" id="short_description_{{$locale}}" cols="30" rows="3"
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="weight" id="weight" class="form-control" value="{{old('weight', $item->weight)}}">
                            </div>
                            <div class="form-group">
                                <label for="volume">Valume</label>
                                <input type="text" name="volume" id="volume" class="form-control" value="{{old('volume', $item->volume)}}">
                            </div>
                            <div class="form-group">
                                <label for="avlb_qty">Available quantity</label>
                                <input type="text" name="avlb_qty" id="avlb_qty" class="form-control" value="{{old('avlb_qty', $item->avlb_qty)}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="manufacturer_code" id="manufacturer_code" class="form-control" value="{{old('manufacturer_code', $item->manufacturer_code)}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="promo_price" id="promo_price" class="form-control" value="{{old('promo_price', $item->promo_price)}}">
                            </div>
                            <div class="form-group">
                                <label for="promo_from">Promo From</label>
                                <input type="text" name="promo_from" id="promo_from" class="form-control" value="{{old('promo_from', $item->promo_from)}}">
                            </div>
                            <div class="form-group">
                                <label for="promo_to">Promo to</label>
                                <input type="text" name="promo_to" id="promo_to" class="form-control" value="{{old('promo_to', $item->promo_to)}}">
                            </div>
                            <div class="form-group">
